...
<body>
	...
	<div class = "header">
		...
		<div class = "Topic">
			...
			<p>I'm an award-winning <em>investigative producer</em> and <em>storyteller</em> with extensive experience researching and executing major projects from conception to post production. Strong expertise in health and wellness. Successful at producing entertaining, character driven stories on complex issues. I live in <em> Lincoln, Nebraska,</em> with my wife, Ginny, and our daughter, Olive. We also have two sons in college, Calvin and Caleb. </p>
		</div>		
	</div>
